...
<div class="ripple"></div>
 ...
 $result=mysqli_query($db, $query); 
    ...
    <br>
    <br>
    <h2 id="main-field">ER</h2>
    <br>
    <br>
    <form action="nurse/delete.php" method="POST">
    ...
    <td> 
 <input type="checkbox" name="stud_delete_id[]" value="<?= $row['numbers']; ?>">&nbsp; &nbsp;  &nbsp; &nbsp; <?php echo $rows['docname']; ?></td>
